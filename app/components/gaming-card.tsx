...
export default function GamingCard({ slug, title, description, date, author, category, image }: GamingCardProps) {
  return (
    <motion.article
    ...
    >
      ...
      <Link href={`/gaming/${slug}`} className="absolute inset-0 z-10" aria-label={`Read more about ${title}`}>
